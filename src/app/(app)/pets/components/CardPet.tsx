...
export function CardPet({ pet }: CardPetType) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`rounded-full w-16 h-16 object-cover ${pet.gender === 'M' ? 'bg-blue-300' : 'bg-pink-300'}`}
      />

      <div className='flex flex-col'>
        <h3
          className={`text-lg font-normal ${pet.gender === 'M' ? 'text-[#5888ED]' : 'text-[#9A0963]'}`}
        >
          {pet.petName}
        </h3>
