    ...
    <>
      ...
      >
          ...
          <div className="w-full px-3">
            <input
              ...
              {...register('confirmPassword', {
                ...
                pattern: passwordRegex,
                validate: (value) =>
                  value === watchedPassword || 'As senhas devem ser idênticas',
              })}
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full px-3">
            <button
              className="rounded-2xl appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 py-4 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
